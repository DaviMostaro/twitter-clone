...
export namespace Prisma {
  ...
  */
  ...
  export type TrendOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "hashtag" | "counter" | "updateAt", ExtArgs["result"]["trend"]>
  ...
  interface TrendFieldRefs {
    ...
    readonly updateAt: FieldRef<"Trend", 'DateTime'>
  }
  ...
  export type TrendWhereInput = {
    ...
    updateAt?: DateTimeFilter<"Trend"> | Date | string
  }
  ...
  export type TrendScalarWhereWithAggregatesInput = {
    ...
    updateAt?: DateTimeWithAggregatesFilter<"Trend"> | Date | string
  }
